...
<form name="signupForm" action="signup.php" method="POST" onsubmit="return validateForm()">
    <div class="mb-3">
        <label for="full_name" class="form-label">Admin Name</label>
    ...
    <div class="mb-3">
        <label for="username" class="form-label">Username (Prefared Name)</label>
    ...
    <p class="mt-3 text-center" style="color:#333">Already have an account? <a class="sign" href="login.php">Login here</a>.</p>
</form>
                    </div>
                </div>
            </div>
